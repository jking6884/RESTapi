...
add_data = """{
  "data": {
    ...
    {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "creation_date": "2015-06-26", "published": "true", "title": "test string"}
         ,
...
update_data = """{
  "data": {
    "attributes":
        ...
        {"body": "How to build CRUD app with Python, Flask, SQLAlchemy and MySQL. Som reand456989@#$%^%> <html/>", "author": "test string", "creation_date": "2015-06-26", "published": "false", "title": "test string"},
    "type": "posts"
  }
